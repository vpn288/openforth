 ASSEMBLER CURRENT !  ASSEMBLER CONTEXT  !
		  ...
		  0x E8 0x 83 0x 48 0x 3 opcode sub_rax,b#    0x C5 0x 2B 0x 48 0x 3 opcode sub_rax,rbp
		 
		  0x E9 0x 83 0x 48 0x 3 opcode sub_rcx,b#    0x E9 0x 81 0x 48 0x 3 opcode sub_rcx,d#
	      ...
	      0x E8 0x 09 0x 48 0x 3 opcode or_rax,rbp
...
0x C8 0x 39 0x 48 0x 3 opcode cmp_rax,rcx   0x E8 0x 39 0x 48 0x 3 opcode cmp_rax,rbp	  0x D1 0x 39 0x 48 0x 3 opcode cmp_rcx,rdx	  0x F9 0x 81 0x 48 0x 3 opcode cmp_rcx,d# 	  0x FA 0x 81 0x 48 0x 3 opcode cmp_rdx,d# 
		  
    0x CD 0x 44 0x 0F 0x 48 0x 4 opcode cmove_rcx,rbp	0x CD 0x 45 0x 0F 0x 48 0x 4 opcode cmovne_rcx,rbp
	0x C5 0x 42 0x 0F 0x 48 0x 4 opcode cmovc_rax,rbp	0x CA 0x 43 0x 0F 0x 48 0x 4 opcode cmovnc_rcx,rdx
	      
		  0x C9 0x FF 0x 48 0x 3 opcode dec_rcx 
		 
		  0x C8 0x 89 0x 48 0x 3 opcode mov_rax,rcx 	  0x D8 0x 89 0x 48 0x 3 opcode mov_rax,rbx
		  0x F0 0x 89 0x 48 0x 3 opcode mov_rax,rsi 	  0x E8 0x 89 0x 48 0x 3 opcode mov_rax,rbp
		  0x D0 0x 89 0x 4C 0x 3 opcode mov_rax,r10		  0x 00 0x 8B 0x 48 0x 3 opcode mov_rax,[rax]
		  0x 40 0x 8B 0x 48 0x 3 opcode mov_rax,[rax+b#]  0x 01 0x 8B 0x 48 0x 3 opcode mov_rax,[rcx] 
    0x 24 0x 04 0x 8B 0x 48 0x 4 opcode mov_rax,[rsp]     0x 24 0x 44 0x 8B 0x 48 0x 4 opcode mov_rax,[rsp+b#]
		  
		  0x CB 0x 89 0x 48 0x 3 opcode mov_rbx,rcx 	  0x 59 0x 8B 0x 48 0x 3 opcode mov_rbx,[rcx+b#]
		  
		  0x C1 0x C7 0x 48 0x 3 opcode mov_rcx,d#		  0x C1 0x 89 0x 48 0x 3 opcode mov_rcx,rax
    0x 24 0x 4C 0x 8B 0x 48 0x 4 opcode mov_rcx,[rsp+b#]
	0x C2 0x 89 0x 48 0x 3 opcode mov_rdx,rax       0x 51 0x 8B 0x 48 0x 3 opcode mov_rdx,[rcx+b#]	  
	      0x C6 0x 89 0x 48 0x 3 opcode mov_rsi,rax	  0x 30 0x 8B 0x 48 0x 3 opcode mov_rsi,[rax]     
		  0x 71 0x 8B 0x 48 0x 3 opcode mov_rsi,[rcx+b#]	  0x C7 0x 89 0x 48 0x 3 opcode mov_rdi,rax
		  0x 39 0x 8B 0x 48 0x 3 opcode mov_rdi,[rcx]		  0x C5 0x 89 0x 48 0x 3 opcode mov_rbp,rax
		  0x 69 0x 8B 0x 48 0x 3 opcode mov_rbp,[rcx+b#] 	  0x C0 0x 89 0x 49 0x 3 opcode mov_r8,rax
		  0x C1 0x 89 0x 49 0x 3 opcode mov_r9,rax
		  
		   0x 1A 0x 8B 0x 4C 0x 3 opcode mov_r11,[rdx]
		  
	      0x 08 0x 89 0x 48 0x 3 opcode mov_[rax],rcx	  0x 10 0x 89 0x 48 0x 3 opcode mov_[rax],rdx 
		  0x 38 0x 89 0x 48 0x 3 opcode mov_[rax],rdi     0x 28 0x 89 0x 48 0x 3 opcode mov_[rax],rbp
		  0x 00 0x 89 0x 4C 0x 3 opcode mov_[rax],r8 	  0x 08 0x 89 0x 4C 0x 3 opcode mov_[rax],r9 
		  
	0x 1B 0x 14 0x 88 0x 42 0x 4 opcode mov_[rbx+r11],dl 
		    
		  0x 19 0x 89 0x 48 0x 3 opcode mov_[rcx],rbx	  0x 31 0x 89 0x 48 0x 3 opcode mov_[rcx],rsi
		  0x 41 0x 89 0x 48 0x 3 opcode mov_[rcx+b#],rax  0x 59 0x 89 0x 48 0x 3 opcode mov_[rcx+b#],rbx 
		  0x 51 0x 89 0x 48 0x 3 opcode mov_[rcx+b#],rdx  0x 02 0x 89 0x 66 0x 3 opcode mov_[rdx],ax 
		  
    0x 24 0x 44 0x 89 0x 48 0x 4 opcode mov_[rsp+b#],rax	0x 24 0x 4C 0x 89 0x 48 0x 4 opcode mov_[rsp+b#],rcx
	
		  0x 03 0x 88 0x 41 0x 3 opcode mov_[r11],al    0x 03 0x 89 0x 41 0x 66 0x 4 opcode mov_[r11],ax
